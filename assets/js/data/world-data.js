...
const WX_SVG = {
  ...
  blood_moon: `<svg class="wx-icon blood-moon-icon" aria-hidden="true" viewBox="0 0 64 64"><circle class="blood-moon-halo blood-moon-halo--outer" cx="32" cy="32" r="28"/><circle class="blood-moon-halo blood-moon-halo--inner" cx="32" cy="32" r="24"/><circle class="blood-moon-disc" cx="32" cy="32" r="20"/><path class="blood-moon-shadow" d="M42.8 15.2A20 20 0 0 1 19.4 47.8 20 20 0 0 0 42.8 15.2Z"/><path class="blood-moon-light" d="M18.6 22.2A17.2 17.2 0 0 1 39.8 14a20 20 0 0 0-21.7 32.7 17.2 17.2 0 0 1 .5-24.5Z"/><g class="blood-moon-craters"><circle cx="22.5" cy="28" r="3.6"/><circle cx="39.5" cy="22.5" r="2.4"/><circle cx="36.5" cy="40" r="4.2"/><circle cx="24.5" cy="43" r="1.5"/></g><path class="blood-moon-mark" d="M32 3.5 34.2 7 32 10.5 29.8 7Z"/></svg>`,
  blood_moon_cloudy: `<svg class="wx-icon blood-moon-icon" aria-hidden="true" viewBox="0 0 64 64"><circle class="blood-moon-halo blood-moon-halo--inner" cx="22" cy="21" r="16"/><circle class="blood-moon-disc" cx="22" cy="21" r="12"/><path class="blood-moon-shadow" d="M28.5 10.9A12 12 0 0 1 14.4 30.5 12 12 0 0 0 28.5 10.9Z"/><g class="blood-moon-craters"><circle cx="17" cy="18" r="2.1"/><circle cx="25.5" cy="16" r="1.5"/><circle cx="24" cy="25.5" r="2.6"/></g><path class="wx-cloud-dark" d="M24 48c0-6 5-11 11-11 4 0 8 2.5 10 6 1-.5 2-.8 3.5-.8 5 0 9 4 9 9s-4 9-9 9H24c-4.4 0-8-3.6-8-8s3.6-8 8-8Z"/></svg>`,
};
