...
O APK da versão Android atual pode ser baixado diretamente pela [última Release do GitHub](https://github.com/matheussimoes22/clima-de-toussaint/releases/latest). Como esta distribuição ainda não utiliza a Google Play, o Android pode solicitar permissão para instalar aplicativos provenientes do navegador ou do gerenciador de arquivos.
...
- `engine/weather-dynamics.js` distribui cada episódio entre formação de nuvens, pico e dissipação. A curva térmica acompanha nascer e pôr do sol, atinge o pico à tarde e resfria progressivamente até o amanhecer; nuvens, umidade, vento, relevo e ondas de calor alteram a retenção noturna. A época, a temperatura, a umidade e as defasagens regionais determinam se há pancadas convectivas de tarde ou chuva frontal em outro horário. O volume horário soma o total diário e as temperaturas preservam as extremas previstas.
